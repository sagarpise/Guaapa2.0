...
options.registry.AsProductSlider= options.Class.extend(BaseAlanQweb, {
    ...
    _product_configure: function(){
        ...
        const prodData = {
            size:"large",
            subTemplate: webUtils.Markup($(cr._baseAlanQweb("theme_alan.dialog_product_modal", {'type': 'product'})).html()),
            fullSubTemplate:1,
            enableCoreButton:0,
            enableCoreTitle:0,
