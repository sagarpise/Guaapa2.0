odoo.define('theme_alan.s_cat_product_slider_options', function (require) {
"use strict";
...
options.registry.AsCategoryProductSlider= options.Class.extend(BaseAlanQweb, {
    ...
    _cat_product_configure: function(){
        ...
        const catData = {
            size:"large",
            subTemplate:webUtils.Markup($(cr._baseAlanQweb("theme_alan.dialog_cat_modal", {'type': 'product'})).html()),
            fullSubTemplate:1,
            enableCoreButton:0,
            enableCoreTitle:0,
